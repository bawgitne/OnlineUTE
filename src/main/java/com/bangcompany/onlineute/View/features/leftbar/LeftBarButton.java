package com.bangcompany.onlineute.View.features.leftbar;
...
public class LeftBarButton extends JButton {
    private static final Color DEFAULT_BACKGROUND = AppTheme.PRIMARY_BLUE;
    //private static final Color ACTIVE_BACKGROUND = new Color(0, 66, 110);
    private static final Color ACTIVE_BACKGROUND = AppTheme.PRIMARY_BLUE;
    ...
    private ImageIcon loadIcon(String iconName, Color color) {
        ...
        try {
            sourceImage = ImageIO.read(ImageUtil.getIconFile(iconName));
        } catch (IOException e) {
            return null;
        }
