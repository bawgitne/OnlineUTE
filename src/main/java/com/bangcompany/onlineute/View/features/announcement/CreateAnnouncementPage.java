...
public class CreateAnnouncementPage extends JPanel implements Refreshable {
    ...
    public CreateAnnouncementPage() {
        ...
        topPanel.add(new PageTitleLabel("SOAN THONG BAO MOI"), BorderLayout.NORTH);
    ...
    private void buildForm() {
        ...
        if ("ADMIN".equals(role)) {
            adminTargetSelect = new SelectGroup<>("Gui den", List.of("Toan truong", "Toan bo Sinh vien", "Toan bo Giang vien"));
        ...
        gbc.gridy++;
        titleInput = new InputGroup("Tieu de", false);
        mainPanel.add(titleInput, gbc);

        gbc.gridy++;
        gbc.weighty = 1.0;
        gbc.fill = GridBagConstraints.BOTH;
        contentInput = new TextAreaGroup("Noi dung thong bao", 250);
    ...
    private void submitAnnouncement(String role) {
        ...
        if ("ADMIN".equals(role)) {
            ...
            if (selection != null && selection.contains("Sinh vien")) {
                targetType = "ALL_STUDENTS";
            } else if (selection != null && selection.contains("Giang vien")) {
            ...
            if (selectedClass == null) {
                JOptionPane.showMessageDialog(this, "Ban chua chon lop de gui.", "Loi", JOptionPane.ERROR_MESSAGE);
                return;
            }
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "Gui thong bao thanh cong.", "Thong bao", JOptionPane.INFORMATION_MESSAGE);
            titleInput.setValue("");
