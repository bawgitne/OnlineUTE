...
public class CourseDialog extends JPanel {
    ...
    public CourseDialog() {
        ...
        codeInput = new TextInput("Mã môn", false);
        nameInput = new TextInput("Tên môn", false);
        creditInput = new TextInput("Số tín chỉ", false);
    ...
    public void setValues(String code, String name, Integer credit) {
        codeInput.setValue(code == null ? "" : code);
        nameInput.setValue(name == null ? "" : name);
        creditInput.setValue(credit == null ? "" : String.valueOf(credit));
    }
