...
public class ViewGradesPage extends JPanel implements Refreshable {
    ...
    public void onEnter() {
        ...
        List<CourseRegistration> registrations =
                AppContext.getCourseRegistrationService().getRegistrationsByStudent(student.getId());
        ...
        for (CourseRegistration registration : registrations) {
            ...
            if (course != null) studiedCourseIds.add(course.getId());
            ...
            if (mark != null && mark.getFinalScore() != null) {
                ...
                if (finalScore.compareTo(new BigDecimal("8.5")) >= 0) diem4 = "4.0";
                else if (finalScore.compareTo(new BigDecimal("7.0")) >= 0) diem4 = "3.0";
                else if (finalScore.compareTo(new BigDecimal("5.5")) >= 0) diem4 = "2.0";
                else if (finalScore.compareTo(new BigDecimal("4.0")) >= 0) diem4 = "1.0";
                else diem4 = "0.0";
