...
public class ChangePasswordPage extends JPanel implements Refreshable {
    ...
    public ChangePasswordPage() {
        ...
        JLabel subTitle = new JLabel("Vui lòng nhập mật khẩu mới để bảo mật tài khoản");
        ...
        // Add to absolute center of centerPanel via GridBagLayout
